...
setwd("D:\\项目\\231021661.报告--尿液外泌体转录组\\自己重新跑后\\EV-origin\\自己构建组织特异性表达矩阵\\GTEx\\exoRBase3.0.EVP_urine")
list.files()
results<-read.delim("exoRBase3.0.EVP_urine.CIBERSORT-Results.txt",header=T,row.names = 1)
dim(results)
head(results)
...
ggsave(filename="exoRBase3.0.EVP_urine.CIBERSORT-Results.tissue.1_63.pdf",plot=p.final,
       device='pdf',path=".",width=13.5,height=4.5)
####D1 sample
head(c)

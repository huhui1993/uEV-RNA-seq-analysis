# =============================================================================
# Stable and Variable Gene Analysis
# Description: Classify genes as stable/moderate/highly variable based on CV
# Input: all_sample_tpm.txt, sample_info.txt
# Output: CV-based classification tables and plots
# =============================================================================
...
m1 <- merge(data_mean, data_sd, by = c("geneid","Donor"))
head(m1)
write.table(m1,
            "data_mean.add_sd.TPM.donors.txt", 
            sep="\t", col.names=T,quote = F,row.names = F)

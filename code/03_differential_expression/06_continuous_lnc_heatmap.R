...
data<-read.delim("all.gene.FC.final.continue.up.final.xls" ,header=T,row.names = 1)
data.pro<-expr.pro[rownames(data),]
...
pdf(file = "heatmap.gene.cntinue.up.expCount.scaled.addlegend.pdf", 6.2, 6)
...
dev.off()
######continue down
data<-read.delim("all.gene.FC.final.continue.down.final.xls" ,header=T,row.names = 1)
data.pro<-expr.pro[rownames(data),]
...
pdf(file = "heatmap.gene.cntinue.down.expCount.scaled.addlegend.pdf", 6.2, 6)
Heatmap(as.matrix(data.m),cluster_columns = FALSE,cluster_rows = TRUE,
        col=mycol,name = "expression", 
        row_dend_width = unit(8, "mm"),column_split = phenotype$Time,
        row_names_gp=gpar(fontsize = 10),
...
data<-read.delim("all.lnc.FC.final.continue.up.final.xls" ,header=T,row.names = 1)
data.pro<-expr.lnc[rownames(data),]
...
pdf(file = "heatmap.lnc.cntinue.up.expCount.scaled.addlegend.pdf", 6.2, 6)
Heatmap(as.matrix(data.m),cluster_columns = FALSE,cluster_rows = TRUE,
        col=mycol,name = "expression", 
        row_dend_width = unit(8, "mm"),column_split = phenotype$Time,
        row_names_gp=gpar(fontsize = 10),
...
dev.off()
################continue lnc down
data<-read.delim("all.lnc.FC.final.continue.down.final.xls" ,header=T,row.names = 1)
data.pro<-expr.lnc[rownames(data),]
...
pdf(file = "heatmap.lnc.cntinue.down.expCount.scaled.addlegend.pdf", 6.2, 6)
Heatmap(as.matrix(data.m),cluster_columns = FALSE,cluster_rows = TRUE,
        col=mycol,name = "expression", 
        row_dend_width = unit(8, "mm"),column_split = phenotype$Time,
        row_names_gp=gpar(fontsize = 10),
